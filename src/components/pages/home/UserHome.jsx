...
import {AlertBadge, Dropdown, Card, CardHeader, CardBody, MoreLessPanel} from 'blueprint-react'
        ...
        <ThemeProvider theme={theme}>
            <div className = 'home'>
                <div className="homeContainer">
                    ...
                    <Header spacing={Header.SPACING.COMPRESSED} heading={<span>User Dashboard <span style={{fontSize: '50%'}}>(Project Marigold)</span></span>} tools={tools}/>
